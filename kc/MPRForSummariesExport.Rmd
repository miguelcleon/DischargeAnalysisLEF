...
startDate <- as.POSIXct("1986-01-01") 
...
mergeflowCloseDaily<- mergeflow[c("Date","cfsmprUSGS","cfsmprJody","DischargeDiff")]
```
...
MPRFullFlow2<- MPRFullFlow2[c("Date", "DateTime","USGS_cfps","USGS_STAGE","cfsUSGS_mean_daily","cfsFromJody_mean_daily")]
...
MPRForSummariesMerged<- MPRForSummariesMerged[c("Date", "DateTime","Sample_Date","cfsmprUSGS", "cfsmprJody", "USGS_cfps")]

write.csv(MPRForSummariesMerged2,
     "./MPRExport4-full.csv",na="NA",,row.names=TRUE)
